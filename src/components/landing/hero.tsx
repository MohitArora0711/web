...
function Hero() {
    ...
    return (
        <div className='text-center mb-36 flex justify-center items-center flex-col '>
            ...
            <p className=' md:text-2xl text-semibold  my-3  text-gray-600 w-[70%]'>{"Come join us for a three-day literary extravaganza! Click on the register button, fill in your details, download your pass, and you're all set to be a part of our grandest edition yet!"}</p>
