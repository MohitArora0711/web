...
const Contact = ()  => {
    return (
        <div id="venue" className="p-4 md:p-28 flex">
            <div className="bg-black gap-20 px-8 md:px-16 md:py-24 text-white rounded-[40px] flex flex-col md:flex-row md:justify-between md:items-center w-full ">
                <div className="w-full md:w-1/2 mt-16">
                    ...
                    <p className="mb-6">You can connect us : </p>
                    <div className="flex flex-row flex-wrap gap-8 mb-6 z-20">
                        <div className="flex flex-col gap-4">
                            <h3 className="font-bold bricolage-grotesque text-3xl">CONTACT US</h3>
                            <a href="tel:+918595870292" className="text-gray-400 ">+91 8595870292</a>
                        </div>
                        <div className="flex flex-col gap-4">
                            <h3 className="font-bold bricolage-grotesque text-3xl">EVENT LOCATION</h3>
                            <p className="text-gray-400">University of Delhi</p>
                        </div>
                        <div className="flex flex-col gap-4">
                            <h3 className="font-bold bricolage-grotesque text-3xl">EMAIL</h3>
                ...
                <div className="w-full mb-8 md:w-1/2 bg-gradient-to-br from-purple-500 to-blue-400 p-2 mt-12 rounded-[30px] md:rounded-[40px] ">
                    <iframe
