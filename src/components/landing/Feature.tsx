...
export default function Features() {
    ...
    return (
        <motion.section
            ...
            viewport={{ once: true }}
            className="flex flex-col justify-center h-full gap-6 p-5 md:p-10 md:px-32"
        >
            <motion.section
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="flex flex-col items-start">
                        <h1 className="text-4xl font-bold text-white bricolage-grotesque">Speakers</h1>
                        <div className="flex flex-row gap-4 mt-10">
                            <div className="flex w-1/3">
                                <div className="items-center justify-center hidden w-12 h-12 bg-gray-200 rounded-full md:flex">
                    ...
                    <div className="flex flex-row gap-12 items-l md:flex-row">
                        {/* <AvatarCircles numPeople={5} avatar`Urls={avatars} /> */}
                ...
                <div className="flex flex-col gap-6 md:w-1/2">
                    ...
                    >
                        <h1 className="text-4xl font-bold bricolage-grotesque">Workshops</h1>
                    ...
                    >
                        ...
                        <div className="relative flex flex-col w-full h-full gap-6 text-black">
                            <h1 className="text-4xl font-bold bricolage-grotesque">Networking Opportunities</h1>
                            <p className="w-[95%] text-lg">
            ...
            >
                <h1 className="text-4xl font-bold bricolage-grotesque">Exhibition</h1>
                <p className="w-[95%] text-lg">
                    Practical sessions on fundraising, MVP building, product development, and team building.
                    Gain expert insights and actionable strategies to launch, scale, and sustain a successful business.
                </p>
